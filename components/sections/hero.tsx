...
const stack = ["Python", "FastAPI", "AWS", "OpenAI", "PostgreSQL", "Redis", "Docker", "Vector Search"]
      ...
      <motion.div style={{ y, opacity }} className="container mx-auto max-w-4xl relative z-10 text-center">
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight leading-[1.1]">
          <MaskedText delay={0.2} className="block">
            <span className="text-ink">Building Production AI Systems</span>
          </MaskedText>
        ...
        <MaskedText delay={0.5} className="mb-10">
          <p className="text-lg md:text-xl text-subtle max-w-2xl mx-auto leading-relaxed">
            I build reliable AI infrastructure, document automation systems, and high-performance backend
            architectures — using Python, FastAPI, AWS, and LLM integrations in production.
          </p>
        </MaskedText>
        ...
        >
          <MagneticButton
            ...
            strength={20}
            className="inline-flex items-center gap-2 bg-ink text-canvas px-6 py-3 rounded-lg font-medium hover:bg-accent-blue hover:text-canvas transition-colors"
          >
